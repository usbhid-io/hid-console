(function() {
  ...
  var onDeviceAdded = function(device) {
    ...
    console.log(" _   _ ___| |__ | |__ (_) __| | (_) ___  ");
    console.log("| | | / __| '_ \| '_ \| |/ _` | | |/ _ \ ");
    console.log("| |_| \__ \ |_) | | | | | (_| |_| | (_) |");
    console.log(" \__,_|___/_.__/|_| |_|_|\__,_(_)_|\___/ ");
    ...
    console.log("Usage: ", device.collections[0].usage);
    console.log("Usage Page: ", device.collections[0].usagePage);
    console.log("Report Ids: ", device.collections[0].reportIds);
    console.log("Max Input ReportSize: ", device.maxInputReportSize);
    console.log("Max Output ReportSize: ", device.maxOutputReportSize);
    console.log("Max Feature ReportSize: ", device.maxFeatureReportSize);
    console.log("Device Descriptor: ", new Uint8Array(device.reportDescriptor));

    // More here: https://developers.chrome.com/apps/hid
